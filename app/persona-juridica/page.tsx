      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <h1 className="text-3xl font-bold text-foreground">Persona Jurídica</h1>
            <p className="text-muted-foreground mt-2">
              Gestiona los trámites de personas jurídicas
            </p>
          </div>
          <Button
        ...
        {showForm && (
          <Card className="mb-8">
            <CardHeader>
              <CardTitle>Nuevo Trámite de Persona Jurídica</CardTitle>
              <CardDescription>
                Completa los datos del trámite de persona jurídica
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <CardContent className="pt-6">
            <div className="flex gap-2">
              <div className="relative flex-1">
                ...
                <input
                  type="text"
                  placeholder="Buscar por expediente, denominación, representante..."
                  value={searchTerm}
